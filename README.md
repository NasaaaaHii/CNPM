...
├── backend/
├── src/
│   ├── config/            # Configuration (Supabase, env, constants)
│   │   └── supabaseClient.ts
│   │
│   ├── core/              # Core utilities & middleware
│   │   ├── errors/        # Custom error classes
│   │   ├── middlewares/   # Auth, RBAC, logging, validation middleware
│   │   └── utils/         # Helper functions
│   │
│   ├── modules/           # Modular domain-based structure
│   │   ├── auth/
│   │   │   ├── auth.route.ts
│   │   │   ├── auth.controller.ts
│   │   │   ├── auth.service.ts
...
│   │   │
│   │   └── vehicleCheck/
│   │       ├── vehicleCheck.route.ts
│   │       ├── vehicleCheck.controller.ts
│   │       ├── vehicleCheck.service.ts
│   │       ├── vehicleCheck.validation.ts
│   │       └── vehicleCheck.model.ts
│   │
│   ├── app.ts             # Initialize express app + load all routes + middleware
│   └── server.ts          # Start server
│
├── scripts/               # Scripts for automation (db seed, cron jobs…)
